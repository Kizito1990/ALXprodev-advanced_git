...
| Use `hotfix/*` branches   | Apply emergency fixes directly to `main` and merge back into `develop`      |
| Document Your Workflow    | Maintain clear documentation of your Git-Flow process                       |
...
git flow hotfix finish <x.x.x>   # Finish hotfix and merge into main
